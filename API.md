...
| <code><a href="#cdk-docker-image-deployment.DockerImageDeployment.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-docker-image-deployment.DockerImageDeployment.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-docker-image-deployment.DockerImageDeployment.with.parameter.mixins"></a>
